...
export const signUp = catchAsync(async (req, res, next) => {
    ...
    const html = `
        ...
        <div class="wrapper">
            <div class="header">
            <div class="project-name">Group 54 Bookshop</div>
            ...
            <p>
                Thank you for signing up for <strong>Group 54 Bookshop</strong>!
            ...
            <p style="margin-top: 10px;">
                © Group 54 Bookshop — All rights reserved.
            </p>
            </div>
        </div>
        </body>
    ...
    try {
        await sendEmail({
            to: newUser.email,
            subject: "Welcome to our bookshop - verify your email",
            html
        });
